...
} ISM [OSPF_ISM_STATE_MAX][OSPF_ISM_EVENT_MAX] =
{
  ...
  },
  {
    ...
    { ism_interface_down,  ISM_Down },          /* InterfaceDown  */
    { ism_begin_leaving,   ISM_Leaving },       /* PredicedLinkDown */
    { ism_ignore,          ISM_PointToPoint },  /* PredicedLinkUp */
  },
  {
    /* DROther: */
    { ism_ignore,          ISM_DependUpon },    /* NoEvent        */
    ...
    { ism_interface_down,  ISM_Down },          /* InterfaceDown  */
    { ism_begin_leaving,   ISM_Leaving },       /* PredicedLinkDown */
    { ism_ignore,          ISM_DROther },       /* PredicedLinkUp */
  },
  {
    /* Backup: */
    { ism_ignore,          ISM_DependUpon },    /* NoEvent        */
    ...
    { ism_interface_down,  ISM_Down },          /* InterfaceDown  */
    { ism_begin_leaving,   ISM_Leaving },       /* PredicedLinkDown */
    { ism_ignore,          ISM_Backup },        /* PredicedLinkUp */
  },
  {
    /* DR: */
    { ism_ignore,          ISM_DependUpon },    /* NoEvent        */
    ...
    { ism_interface_down,  ISM_Down },          /* InterfaceDown  */
    { ism_begin_leaving,   ISM_Leaving },       /* PredicedLinkDown */
    { ism_ignore,          ISM_DR },            /* PredicedLinkUp */
  },
  {
    /* ISM_Leaving: */
    { ism_ignore,          ISM_DependUpon },    /* NoEvent        */
    ...
    { ism_interface_down,  ISM_Down },          /* InterfaceDown  */
    { ism_begin_leaving,   ISM_Leaving },       /* PredicedLinkDown */
    { ism_end_leaving,     ISM_DependUpon },  /* PredicedLinkUp */
  },
  {
    /* ISM_SE: */
    { ism_ignore,          ISM_DependUpon },    /* NoEvent        */
...
ism_change_state (struct ospf_interface *oi, int state)
{
  ...
  //normal leaving related change, alse send lsa in ospf_plus
...
ospf_ism_event (struct thread *thread)
{
  ...
  if(MY_DEBUG)
    zlog_debug("in func ospf_ism_event 1, event = %d, oi->state = %d", event, oi->state);
  /* Call function. */
  ...
  if(MY_DEBUG)
    zlog_debug("in func ospf_ism_event 2, next_state = %d\n", next_state);
